 ...
 * Project: TGTGamer
 * File: index.ts
 * Path: \portfolio\LeetCode\1342_number_of_steps_to_reduce_a_number_to_zero\index.ts
...
export * as NumberOfStepsToReduceANumberToZero from './1342_number_of_steps_to_reduce_a_number_to_zero';

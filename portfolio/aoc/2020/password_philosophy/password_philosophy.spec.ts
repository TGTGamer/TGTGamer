...
const values = `15-16 m: mhmjmzrmmlmmmmmm
5-6 d: dcdddhzld
3-4 s: vqssdcbl
3-6 b: bbhbbbqbbb
10-11 q: cqqntqhqwwh
...
it('should return the correct value', () => {
  expect(passwordPhilosophy.countValid(valuesSplit)).not.toBeNaN();
});
it('should return the correct value', () => {
  expect(passwordPhilosophy.countValid(valuesSplit)).toBe(636);
});
it('should return the correct value', () => {
  expect(passwordPhilosophy.positionValid(valuesSplit)).not.toBeNaN();
});
it('should return the correct value', () => {
  expect(passwordPhilosophy.positionValid(valuesSplit)).toBe(588);
});

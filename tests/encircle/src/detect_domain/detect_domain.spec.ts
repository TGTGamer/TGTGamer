...
import {detectDomain} from "../../../../packages/encircle/src/detect_domain/detect_domain.js";
...
it('to produce the correct array', () => {
    ...
    const path = fileURLToPath(new URL("../../fixtures/task_1.html", import.meta.url))

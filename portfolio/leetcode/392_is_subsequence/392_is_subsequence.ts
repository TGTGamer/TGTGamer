 ...
 * -----
 * Project: TGTGamer
 * File: 392_is_subsequence.ts
 * Path: \portfolio\LeetCode\392_is_subsequence\392_is_subsequence.ts
...
export function IsSubsequence(s: string, t: string): boolean {
  ...
  // sIndex will be used to track the order of letters
  let sIndex: number = -1;
  ...
  for (let i in [...s]) {
      ...
      let index = t.indexOf(s[i], sIndex + 1)
